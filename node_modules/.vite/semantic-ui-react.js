...
var require_nodeUtil = __commonJS((exports, module) => {
  ...
  var nodeUtil_default = nodeUtil2;
});
...
var require_event_stack_development = __commonJS((exports) => {
  "use strict";
...
var require_keyboardKey = __commonJS((exports, module) => {
  "use strict";
...
function baseIsEqualDeep(object, other, bitmask, customizer, equalFunc, stack) {
  ...
  if (isSameTag && (0, import_isBuffer2.default)(object)) {
    if (!(0, import_isBuffer2.default)(other)) {
      return false;
    }
    objIsArr = true;
    objIsObj = false;
...
function isEmpty(value) {
  ...
  if (isArrayLike_default(value) && (isArray_default(value) || typeof value == "string" || typeof value.splice == "function" || (0, import_isBuffer3.default)(value) || isTypedArray_default(value) || isArguments_default(value))) {
    return !value.length;
  }
...
function preventOverflow(_ref) {
  ...
  if (checkMainAxis || checkAltAxis) {
    ...
    if (checkAltAxis) {
      ...
      var _preventedOffset = within(tether ? min2(_min, tetherMin) : _min, _offset, tether ? max(_max, tetherMax) : _max);
